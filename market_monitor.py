...
class MarketMonitor:
                ...
                for future in concurrent.futures.as_completed(future_to_code):
                    ...
                    try:
                        ...
                        self.fund_data[fund_code] = {
                            ...
                            'ma_ratio': np.nan, 'macd_diff': np.nan, 'bb_upper': np.nan, 'bb_lower': np.nan, 'bb_position': 'N/A', 'advice': "观察", 'action_signal': 'N/A'
    ...
    def generate_report(self):
        ...
        for fund_code in self.fund_codes:
            ...
            if data is not None:
                ...
                bollinger_pos = data.get('bb_position', "中轨")  # 使用计算的bb_position
    ...
    def _get_portfolio_signals(self, fund_data, max_positions=3):
...
if __name__ == "__main__":
    ...
    try:
        ...
        monitor.generate_portfolio_recommendation()  # 新增的投资组合推荐生成
